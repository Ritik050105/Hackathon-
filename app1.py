...
# Function to convert text to speech in a desired language
...
def main():
    ...
    # Language selection
    dest_lang = st.selectbox("Select output language", ["en", "es", "fr", "de", "hi", "zh-cn", "ja"])
    ...
    if uploaded_file is not None:
        ...
        extracted_text = extract_text_from_image(image, lang='eng')  # Default to English for OCR
        if extracted_text:
            ...
            # Translate text
            translated_text = translate_text(cleaned_text, dest_lang=dest_lang)
            ...
            if summary:
                ...
                audio_file = text_to_speech(final_text, lang=dest_lang)
                if audio_file:
